...
export default function OperatorLiquidityPoolPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your fleet's liquidity and token swaps</p>
        </div>
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Card className="overflow-hidden h-full border-dashed">
                    <CardContent className="p-6 flex flex-col items-center justify-center h-full text-center">
                      ...
                      <Button className="bg-[#f68b27] hover:bg-[#f68b27]/90">Create Pool</Button>
                    </CardContent>
                  </Card>
                </motion.div>
              </div>
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Card className="overflow-hidden h-full border-dashed">
                    <CardContent className="p-6 flex flex-col items-center justify-center h-full text-center">
                      ...
                      <Button className="bg-[#f68b27] hover:bg-[#f68b27]/90">Import Token</Button>
                    </CardContent>
                  </Card>
                </motion.div>
              </div>
