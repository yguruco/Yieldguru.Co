    ...
    return (
        <div className="flex justify-center mt-8">
            <Wallet>
                ...
                <ConnectWallet
                    className="w-full rounded-full bg-white text-[#fbdc3e] font-semibold py-3 px-6 hover:bg-[#3b1149] transition-all duration-300 shadow-md border border-[#fbdc3e]/20"
