          ...
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">The Piano, Brookside Drive, Westlands</span>
              </li>
              <li className="flex items-center">
                <Phone className="mr-3 h-5 w-5 text-[#fbdc3e]" />
                <span className="text-gray-300">(+254) 705810850</span>
              </li>
              <li className="flex items-center">
                <Mail className="mr-3 h-5 w-5 text-[#fbdc3e]" />
                <span className="text-gray-300">eliud@yieldguru.co</span>
              </li>
            </ul>
          </motion.div>
        </div>
